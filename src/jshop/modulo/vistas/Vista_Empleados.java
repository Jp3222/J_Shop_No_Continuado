 ...
 * @author jp
 */
public final class Vista_Empleados extends Vista implements Observador, BasicoFrame {
     ...
     * @param menu
     */
    public Vista_Empleados(Vista_Administracion administracion) {
        super("productos");
        //variables
    ...
    public void initVariables() {
        controlador = new Con_Productos(null);
    ...
    public String[] getInserccion() {
        ...
        int i = -1;
        try {
            ResultSet SELECT = Conexion.getInstancia().select("marcas", "id", "nombre = '" + info[3] + "'");
            if (SELECT.next()) {
                i = SELECT.getInt("id");
                info[3] = "" + i;
            }
        } catch (SQLException ex) {
            Logger.getLogger(Vista_Empleados.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jpRootLayout.setHorizontalGroup(
            ...
            .addGroup(jpRootLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jtpCRUD, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
